...
export default function AuthForm() {
  ...
  return (
    <div className="auth-card" onClick={(e) => e.stopPropagation()}>
      {/* ── Liquid Glass shimmer layers ── */}
      <div className="glass-shimmer" />
      <div className="glass-shimmer glass-shimmer--2" />
      ...
      <form onSubmit={handleSubmit} className="auth-form">
        ...
        <button type="submit" className="auth-submit">
          <span className="auth-submit__glow" />
      ...
      <div className="auth-divider">
        ...
        <span className="auth-divider__text">OR SIGN IN WITH</span>
        <span className="auth-divider__line" />
      </div>
      ...
      <p className="auth-footer">
        {mode === 'signup'
          ? <>By creating an account, you agree to our <a href="#terms">Terms & Service</a></>
